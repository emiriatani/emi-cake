...
/**
 * @ClassName com.myf.myproject.service.Impl SendSmsServiceImpl
...
public class SendSmsServiceImpl implements SendSmsService {
     ...
     **/
    @Override
    public boolean send(String phoneNum, String templateCode, Map<String, Object> code) throws ClientException, JsonProcessingException {
        //设置超时时间-可自行调整
        ...
        request.putQueryParameter("TemplateParam", new ObjectMapper().writeValueAsString(code));
        CommonResponse response = DefaultAcsClient.getCommonResponse(request);
        log.info("发送短信成功,响应数据为:" + response.getData());
        //发送验证码是否成功,成功就返回
